...
public class CarPostStoreClient {
    ...
    public List<CarPostDTO> carForSaleClient(){
        ResponseEntity<CarPostDTO[]> responseEntity = restTemplate.getForEntity(
                POST_STORE_SERVICE_URI + "/cars", CarPostDTO[].class);
        return Arrays.asList(Objects.requireNonNull(responseEntity.getBody()));
    }

    public void ownerClient(OwnerPostDTO newUser){
    ...
    public void changeCarForSaleClient(CarPostDTO carPostDTO, String id){
        restTemplate.put(POST_STORE_SERVICE_URI + "/car/" + id, carPostDTO, OwnerPostDTO.class);
    }
